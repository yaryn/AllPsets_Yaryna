...
{
    // перевірка на кількість введених аргументів у ком.рядку,
    ...
    // линейный алгоритм и 48-битных целочисленных арифметических операций:
    ...
    // Эти функции объявлены устаревшими by SVID 3 
    // и вместо этого следует использовать rand(3)
